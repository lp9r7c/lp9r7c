<p align="center">─── 🛠️ NETWORK ENGINEER & SOC ANALYST 🛡️ ───</p>

<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=1a1a1a&height=200&section=header&text=lp9r7c&fontSize=80&animation=fadeIn&fontAlignY=35&fontColor=00d4ff" />
</p>
...
### 🛡️ Arsenal Cybersécurité (SOC & SecOps)

* **SIEM/XDR Management** : Administration avancée de **Wazuh** (Analyse de logs, détection d'intrusions, conformité et réponse aux incidents).
* **Network Security** : Durcissement des pare-feu (Firewalling), implémentation de tunnels **Wireguard/Zero-Trust** et filtrage DNS via **AdGuard Home**.
* **Secrets & Identity** : Gestion centralisée des accès via **Vaultwarden** et sécurisation des flux via **Nginx Proxy Manager** (SSL/TLS).
* **Audit & Pentesting** : Analyse de vulnérabilités via **Nmap** et analyse de paquets en profondeur avec **Wireshark**.

---

### 🏗️ Enterprise-Grade Lab Setup
...
| **Cloud Edge** | Cloudflare Zero Trust | `PROTECTED` |
...
<p align="right">
  <img src="https://img.shields.io/badge/Network_Security-A+_Rating-brightgreen?style=flat-square" />
  <img src="https://img.shields.io/badge/System_Status-Operational-blue?style=flat-square" />
